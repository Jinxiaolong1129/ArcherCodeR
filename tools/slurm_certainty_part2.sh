...
#SBATCH --output=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/logs/slurm_certainty_part2_%j.txt
#SBATCH --error=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/logs/slurm_certainty_part2_error_%j.txt
#SBATCH --job-name=cert-p2
#SBATCH --exclusive

# Part 2: TrajectoryEntropy-simple (24 files) + TrajectoryEntropy-temp0.8 (24 files) = 48 files
...
echo "Part 2: TrajectoryEntropy-simple + TrajectoryEntropy-temp0.8"
...
# Experiments to process in Part 2
EXPERIMENTS=(
