...
#SBATCH --output=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/logs/slurm_certainty_part1_%j.txt
#SBATCH --error=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/logs/slurm_certainty_part1_error_%j.txt
#SBATCH --job-name=cert-p1
#SBATCH --exclusive

# Part 1: TokenEntropy (36 files) + TrajectoryEntropy-n12 (24 files) = 60 files
...
echo "Part 1: TokenEntropy + TrajectoryEntropy-n12"
...
# Experiments to process in Part 1
EXPERIMENTS=(
