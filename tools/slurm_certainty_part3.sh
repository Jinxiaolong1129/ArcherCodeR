...
#SBATCH --output=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/logs/slurm_certainty_part3_%j.txt
#SBATCH --error=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/logs/slurm_certainty_part3_error_%j.txt
#SBATCH --job-name=cert-p3
#SBATCH --exclusive
...
echo "Part 3: TrajectoryEntropy-n8 + TrajectoryEntropy-temp1.2 + Pure-GRPO"
