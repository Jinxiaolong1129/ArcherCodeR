...
#SBATCH --output=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/logs/slurm_certainty_part12_%j.txt
#SBATCH --error=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/logs/slurm_certainty_part12_error_%j.txt
#SBATCH --job-name=cert-p12
#SBATCH --exclusive

# Part 1+2 Combined: TokenEntropy + TrajectoryEntropy-n12 + TrajectoryEntropy-simple + TrajectoryEntropy-temp0.8
# ~108 files total
...
# Combined experiments from Part 1 and Part 2
EXPERIMENTS=(
    # Part 1
