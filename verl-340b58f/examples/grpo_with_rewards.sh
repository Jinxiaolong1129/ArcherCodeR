...
# GRPO with WizardRewardManager + rewards/general_reward.py (like DAPO)
# This script demonstrates how to use GRPO with rich analysis and the same reward functions as DAPO
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name=grpo_with_rewards \
    trainer.save_freq=10 \
    trainer.test_freq=10 \
    trainer.total_epochs=1 2>&1 | tee verl_grpo_rewards.log
