...
#SBATCH --output=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/Archer_eval/tools/logs/slurm_eval_minerva_part4_%j.txt
#SBATCH --error=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/Archer_eval/tools/logs/slurm_eval_minerva_part4_error_%j.txt
#SBATCH --job-name=minerva-p4
...
bash tools/batch_merge_eval_minerva_part4.sh 2>&1 | tee tools/logs/batch_eval_minerva_part4_${SLURM_JOB_ID}.log
