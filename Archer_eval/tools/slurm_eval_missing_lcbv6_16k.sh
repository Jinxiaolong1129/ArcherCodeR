...
#SBATCH --output=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/Archer_eval/tools/logs/slurm_eval_missing_lcbv6_16k_%j.txt
#SBATCH --error=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/Archer_eval/tools/logs/slurm_eval_missing_lcbv6_16k_error_%j.txt
...
bash tools/batch_eval_missing_lcbv6_16k.sh 2>&1 | tee tools/logs/batch_eval_missing_lcbv6_16k_${SLURM_JOB_ID}.log
