...
#SBATCH --output=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/Archer_eval/tools/logs/slurm_eval_lcb_v6_16k_missing_%j.txt
#SBATCH --error=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/Archer_eval/tools/logs/slurm_eval_lcb_v6_16k_missing_error_%j.txt
#SBATCH --job-name=lcbv6-16k-miss
...
bash tools/batch_merge_eval_lcb_v6_16k_missing.sh 2>&1 | tee tools/logs/batch_eval_lcb_v6_16k_missing_${SLURM_JOB_ID}.log
