...
#SBATCH --output=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/Archer_eval/tools/logs/slurm_eval_lcb_16k_part2_%j.txt
#SBATCH --error=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/Archer_eval/tools/logs/slurm_eval_lcb_16k_part2_error_%j.txt
#SBATCH --job-name=lcb16k-p2
...
bash tools/batch_merge_eval_lcb_16k_part2.sh 2>&1 | tee tools/logs/batch_eval_lcb_16k_part2_${SLURM_JOB_ID}.log
