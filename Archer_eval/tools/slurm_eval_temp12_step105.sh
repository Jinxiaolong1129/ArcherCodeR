...
#SBATCH --output=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/Archer_eval/tools/logs/slurm_eval_temp12_step105_%j.txt
#SBATCH --error=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/Archer_eval/tools/logs/slurm_eval_temp12_step105_error_%j.txt
#SBATCH --job-name=temp12-s105
...
bash tools/batch_merge_eval_temp12_step105.sh 2>&1 | tee tools/logs/batch_eval_temp12_step105_${SLURM_JOB_ID}.log
