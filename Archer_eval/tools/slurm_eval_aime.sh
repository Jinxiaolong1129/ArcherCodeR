...
#SBATCH --output=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/Archer_eval/tools/logs/slurm_eval_aime_%j.txt
#SBATCH --error=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/Archer_eval/tools/logs/slurm_eval_aime_error_%j.txt
#SBATCH --job-name=eval-aime
...
bash tools/batch_merge_eval_aime.sh 2>&1 | tee tools/logs/batch_eval_aime_${SLURM_JOB_ID}.log
