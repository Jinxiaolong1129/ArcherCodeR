...
#SBATCH --output=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/Archer_eval/tools/logs/slurm_eval_all_%j.txt
#SBATCH --error=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/Archer_eval/tools/logs/slurm_eval_all_error_%j.txt
...
bash tools/batch_merge_eval_all.sh 2>&1 | tee tools/logs/batch_eval_all_${SLURM_JOB_ID}.log
