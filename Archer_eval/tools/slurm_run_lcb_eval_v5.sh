...
#SBATCH --output=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/Archer_eval/tools/logs/slurm_run_lcb_eval_v5_%j.txt
#SBATCH --error=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/Archer_eval/tools/logs/slurm_run_lcb_eval_v5_error_%j.txt
#SBATCH --job-name=lcb-eval-v5
...
bash tools/run_lcb_eval_v5.sh 2>&1 | tee tools/logs/run_lcb_eval_v5_${SLURM_JOB_ID}.log
