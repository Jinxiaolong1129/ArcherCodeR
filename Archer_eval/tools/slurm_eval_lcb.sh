...
#SBATCH --output=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/Archer_eval/tools/logs/slurm_eval_lcb_%j.txt
#SBATCH --error=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/Archer_eval/tools/logs/slurm_eval_lcb_error_%j.txt
#SBATCH --job-name=eval-lcb
...
bash tools/batch_merge_eval_lcb.sh 2>&1 | tee tools/logs/batch_eval_lcb_${SLURM_JOB_ID}.log
