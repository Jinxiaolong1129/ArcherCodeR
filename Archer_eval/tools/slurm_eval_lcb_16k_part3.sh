...
#SBATCH --output=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/Archer_eval/tools/logs/slurm_eval_lcb_16k_part3_%j.txt
#SBATCH --error=/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/Archer_eval/tools/logs/slurm_eval_lcb_16k_part3_error_%j.txt
#SBATCH --job-name=lcb16k-p3
...
bash tools/batch_merge_eval_lcb_16k_part3.sh 2>&1 | tee tools/logs/batch_eval_lcb_16k_part3_${SLURM_JOB_ID}.log
