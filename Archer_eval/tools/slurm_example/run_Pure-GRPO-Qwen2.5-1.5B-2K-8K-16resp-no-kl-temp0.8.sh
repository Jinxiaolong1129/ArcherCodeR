...
exp_name='Pure-GRPO-Qwen2.5-1.5B-2K-8K-16resp-no-kl-temp0.8-v2'
...
# Response generation - TEMPERATURE 0.8
...
echo "🚀 PURE GRPO CONFIGURATION (NO KL - TEMP 0.8):"
...
/data/xuandong_zhao/anaconda3/envs/archer/bin/python -m verl.trainer.main_ppo \
    ...
    +trainer.save_interval_after_first=20 \
