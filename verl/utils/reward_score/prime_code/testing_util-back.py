...
def run_test(in_outs, test=None, debug=False, timeout=15):
    ...
    if test is None:
        ...
        results = []
        # Reduced recursion limit from 600000 to 10000 to prevent C stack overflow (segfaults)
        # 10000 is sufficient for most legitimate recursive algorithms while preventing runaway recursion
