...
class ActorRolloutRefWorker(Worker):
    ...
    def compute_log_prob(self, data: DataProto):
        ...
        with self.ulysses_sharding_manager:
            ...
            output = DataProto.from_dict(
                tensors={"old_log_probs": output, "entropys": entropys, "self_certaintys": self_certaintys, "prob_disparitys": prob_disparitys},
    ...
    def compute_ref_log_prob(self, data: DataProto):
        ...
        with self.ulysses_sharding_manager:
            data = self.ulysses_sharding_manager.preprocess_data(data)
            output, _, _, _ = self.ref_policy.compute_log_prob(data=data, calculate_entropy=False, calculate_self_certainty=False, calculate_prob_disparity=False)
