...
#SBATCH --output=./output/ArcherCodeR/Pure-GRPO-Qwen2.5-1.5B-2K-8K-16resp-no-kl-from-intuitor-step50/slurm_out_%j.txt
#SBATCH --error=./output/ArcherCodeR/Pure-GRPO-Qwen2.5-1.5B-2K-8K-16resp-no-kl-from-intuitor-step50/slurm_error_%j.txt
#SBATCH --job-name=grpo-from-intuitor-step50
...
# 创建输出目录
mkdir -p ./output/ArcherCodeR/Pure-GRPO-Qwen2.5-1.5B-2K-8K-16resp-no-kl-from-intuitor-step50

# ============================================
# Step 1: Merge FSDP checkpoint to HF format
# ============================================
INTUITOR_CHECKPOINT_PATH=./output/ArcherCodeR/Archer-Intuitor-Qwen2.5-1.5B-2k-8k-batch64-no-kl-simple-v2/global_step_50/actor
...
bash scripts-iclr-server/train/run_Pure-GRPO-Qwen2.5-1.5B-2K-8K-16resp-no-kl-from-intuitor-step50.sh
