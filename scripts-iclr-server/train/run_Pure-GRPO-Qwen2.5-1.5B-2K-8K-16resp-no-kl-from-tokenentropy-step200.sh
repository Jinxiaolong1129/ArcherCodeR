...
exp_name='Pure-GRPO-Qwen2.5-1.5B-2K-8K-16resp-no-kl-from-tokenentropy-step200'
...
# TokenEntropy checkpoint step 200 - full checkpoint for resume
TOKENENTROPY_CKPT_PATH=./output/ArcherCodeR/Archer-TokenEntropy-Qwen2.5-1.5B-2k-8k-batch64-no-kl-simple/global_step_200
...
echo "🚀 PURE GRPO CONFIGURATION (FROM TOKEN ENTROPY CHECKPOINT STEP 200):"
