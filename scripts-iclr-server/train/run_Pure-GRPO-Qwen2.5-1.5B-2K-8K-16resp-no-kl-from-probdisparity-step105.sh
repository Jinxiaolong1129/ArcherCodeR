...
exp_name='Pure-GRPO-Qwen2.5-1.5B-2K-8K-16resp-no-kl-from-probdisparity-step105'
...
# Resume from ProbDisparity checkpoint step 105
PROBDISPARITY_CHECKPOINT_PATH=./output/ArcherCodeR/Archer-ProbDisparity-Qwen2.5-1.5B-2k-8k-batch64-no-kl-simple/global_step_105
...
echo "🚀 PURE GRPO CONFIGURATION (FROM PROB DISPARITY CHECKPOINT STEP 105):"
...
echo "🔄 Resume from: ${PROBDISPARITY_CHECKPOINT_PATH}"
...
/data/xuandong_zhao/anaconda3/envs/archer/bin/python -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path="${PROBDISPARITY_CHECKPOINT_PATH}/actor/hf_model" \
