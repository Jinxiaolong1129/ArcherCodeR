...
exp_name='Pure-GRPO-Qwen2.5-1.5B-2K-8K-16resp-no-kl-from-intuitor-epoch10lr-step10'
...
INTUITOR_CHECKPOINT_PATH=./output/ArcherCodeR/Archer-Intuitor-Qwen2.5-1.5B-2k-8k-batch64-no-kl-simple-epoch-10-lr/global_step_10
...
echo "🚀 PURE GRPO CONFIGURATION (FROM INTUITOR EPOCH-10-LR CHECKPOINT STEP 10):"
