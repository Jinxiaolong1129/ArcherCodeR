#!/usr/bin/env bash
# =====================================================================
# Pure GRPO Training on LiveCodeBench Dataset (KL 0.005)
# =====================================================================
...
exp_name='Pure-GRPO-LCB-Qwen2.5-1.5B-2K-8K-16resp-kl005'

adv_estimator=grpo

# kl config - ENABLED with KL 0.005
...
echo "🚀 PURE GRPO ON LIVECODEBENCH (KL 0.005):"
...
echo "✅ KL Loss: ENABLED (coef=${kl_loss_coef})"
