...
exp_name='Pure-GRPO-Qwen2.5-1.5B-2K-8K-16resp-no-kl-from-intuitor-step155'
...
# Resume from Intuitor checkpoint step 155
...
echo "🚀 PURE GRPO CONFIGURATION (FROM INTUITOR CHECKPOINT STEP 155):"
...
echo "📊 Training: step 155 → 205 (50 steps)"
