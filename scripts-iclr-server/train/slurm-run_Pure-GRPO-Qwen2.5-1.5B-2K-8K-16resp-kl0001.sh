...
#SBATCH --output=./output/ArcherCodeR/Pure-GRPO-Qwen2.5-1.5B-2K-8K-16resp-kl0001/slurm_out_%j.txt
#SBATCH --error=./output/ArcherCodeR/Pure-GRPO-Qwen2.5-1.5B-2K-8K-16resp-kl0001/slurm_error_%j.txt
#SBATCH --job-name=pure-grpo-qwen2.5-1.5b-2k-8k-16resp-kl0001
...
mkdir -p ./output/ArcherCodeR/Pure-GRPO-Qwen2.5-1.5B-2K-8K-16resp-kl0001

# Stop any existing Ray processes
ray stop --force 2>/dev/null || true

echo "🚀 Starting Pure GRPO Training Job (KL=0.001)"
...
bash scripts-iclr-server/train/run_Pure-GRPO-Qwen2.5-1.5B-2K-8K-16resp-kl0001.sh ray_init.num_cpus=160
