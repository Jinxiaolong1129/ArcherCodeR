...
#SBATCH --output=./output/ArcherCodeR/Pure-GRPO-Qwen2.5-1.5B-2K-8K-n12-no-kl-v2/slurm_out_%j.txt
#SBATCH --error=./output/ArcherCodeR/Pure-GRPO-Qwen2.5-1.5B-2K-8K-n12-no-kl-v2/slurm_error_%j.txt
#SBATCH --job-name=pure-grpo-n12-no-kl
...
bash scripts-iclr-server/train/run_Pure-GRPO-Qwen2.5-1.5B-2K-8K-n12-no-kl.sh
