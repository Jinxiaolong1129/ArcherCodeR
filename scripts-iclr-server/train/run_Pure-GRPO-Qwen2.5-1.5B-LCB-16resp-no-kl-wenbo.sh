#!/usr/bin/env bash
# =====================================================================
# Pure GRPO Training on LiveCodeBench Dataset (NO KL)
# =====================================================================
# This script trains on LiveCodeBench data directly.
# Uses external rewards (ground truth) for training.
# =====================================================================
set -xeuo pipefail
...
exp_name='Pure-GRPO-LCB-Qwen2.5-1.5B-2K-8K-16resp-no-kl-wenbo_server-v2'
...
max_response_length=$((1024 * 4))  # 8K
enable_overlong_buffer=False
overlong_buffer_len=16
overlong_penalty_factor=1.0
v_max_response_length=$((1024 * 4))  # 8K
...
echo "🚀 PURE GRPO ON LIVECODEBENCH (NO KL):"
...
echo "🎯 Algorithm: Pure GRPO (Group Relative Policy Optimization)"
