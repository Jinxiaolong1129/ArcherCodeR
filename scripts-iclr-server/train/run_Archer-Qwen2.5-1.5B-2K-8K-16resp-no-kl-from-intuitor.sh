...
INTUITOR_CHECKPOINT_PATH=./output/ArcherCodeR/Archer-Intuitor-Qwen2.5-1.5B-2k-8k-batch64-no-kl-simple/global_step_80
...
# Add system limits (disabled to avoid breaking Ray startup)
# ulimit -s 8192      # 8MB stack size limit
# ulimit -v 16777216  # 16GB virtual memory limit (too low for Ray/vLLM)
...
/home/ec2-user/miniconda3/envs/archer/bin/python -m dapo.main_dapo \
    ...
    actor_rollout_ref.model.path="${INTUITOR_CHECKPOINT_PATH}/hf_model" \
