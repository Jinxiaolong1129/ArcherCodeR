...
# ================================
# DACE Training Script for ArcherCodeR
# Difficulty-Aware Certainty Exploration
# Based on Archer-Qwen2.5-1.5B configuration
# ================================
...
dace_alpha_scale=0.05          # Intrinsic reward scaling factor (paper: 0.05)
dace_beta_threshold=0.4        # Difficulty threshold (paper: 0.4)
...
echo "🚀 DACE CONFIGURATION:"
echo "╔═══════════════════════════════════════════════════════════════╗"
echo "║ DACE: Difficulty-Aware Certainty Exploration                 ║"
echo "╚═══════════════════════════════════════════════════════════════╝"
...
echo ""
echo "🎲 DACE Hyperparameters (Paper Defaults):"
echo "  ├─ α_scale (intrinsic reward scaling): ${dace_alpha_scale} (paper: 0.05)"
echo "  ├─ β_threshold (difficulty threshold): ${dace_beta_threshold} (paper: 0.4)"
...
echo "  • For HARD tasks (diff > β): α < 0 → explore (low certainty)"
echo "  • For EASY tasks (diff < β): α > 0 → exploit (high certainty)"
...
/home/ec2-user/miniconda3/envs/archer/bin/python -m dapo.main_dapo \
    ...
    +trainer.rejection_sample=True $@ 2>&1 | tee ${CKPTS_DIR}/${project_name}_${exp_name}_dace.log

echo "╔═══════════════════════════════════════════════════════════════╗"
echo "║ ✅ DACE Training Completed                                    ║"
echo "║ 📁 Logs: ${CKPTS_DIR}/${project_name}_${exp_name}_dace.log    ║"
