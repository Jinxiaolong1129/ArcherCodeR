...
exp_name='Pure-GRPO-Qwen2.5-1.5B-2K-8K-16resp-no-kl-from-probdisparity-step50'
...
# Resume from ProbDisparity checkpoint
PROBDISPARITY_CHECKPOINT_PATH=./output/ArcherCodeR/Archer-ProbDisparity-Qwen2.5-1.5B-2k-8k-batch64-no-kl-simple/global_step_50
...
echo "🚀 PURE GRPO CONFIGURATION (FROM PROB DISPARITY CHECKPOINT STEP 50):"
