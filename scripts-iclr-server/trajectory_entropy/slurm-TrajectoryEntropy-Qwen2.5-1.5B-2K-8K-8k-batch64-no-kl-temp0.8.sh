...
#SBATCH --output=./output/ArcherCodeR/Archer-TrajectoryEntropy-Qwen2.5-1.5B-2k-8k-batch64-no-kl-temp0.8/slurm_out_%j.txt
#SBATCH --error=./output/ArcherCodeR/Archer-TrajectoryEntropy-Qwen2.5-1.5B-2k-8k-batch64-no-kl-temp0.8/slurm_error_%j.txt
#SBATCH --job-name=traj-entropy-no-kl-temp0.8
...
bash scripts-iclr-server/trajectory_entropy/trajectory_entropy_Qwen-1.5B-2k-8k-8k-batch64-no-kl-temp0.8.sh
