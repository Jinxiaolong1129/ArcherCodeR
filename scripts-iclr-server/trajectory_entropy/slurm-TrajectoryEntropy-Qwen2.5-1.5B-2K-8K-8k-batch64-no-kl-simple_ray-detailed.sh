...
#SBATCH --output=./output/ArcherCodeR/Archer-TrajectoryEntropy-Qwen2.5-1.5B-2k-8k-batch64-no-kl-simple-epoch-10-lr/slurm_out_%j.txt
#SBATCH --error=./output/ArcherCodeR/Archer-TrajectoryEntropy-Qwen2.5-1.5B-2k-8k-batch64-no-kl-simple-epoch-10-lr/slurm_error_%j.txt
#SBATCH --job-name=traj-entropy-epoch-10-lr
...
mkdir -p ./output/ArcherCodeR/Archer-TrajectoryEntropy-Qwen2.5-1.5B-2k-8k-batch64-no-kl-simple-epoch-10-lr
...
bash scripts-iclr-server/trajectory_entropy/trajectory_entropy_Qwen-1.5B-2k-8k-8k-batch64-no-kl-simple_ray-detailed.sh ray_init.num_cpus=160
