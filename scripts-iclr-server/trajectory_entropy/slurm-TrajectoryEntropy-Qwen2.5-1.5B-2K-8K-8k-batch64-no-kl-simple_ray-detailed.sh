...
#SBATCH --output=./output/ArcherCodeR/Archer-TrajectoryEntropy-Qwen2.5-1.5B-2k-8k-batch64-no-kl-simple-detailed-v2/slurm_out_%j.txt
#SBATCH --error=./output/ArcherCodeR/Archer-TrajectoryEntropy-Qwen2.5-1.5B-2k-8k-batch64-no-kl-simple-detailed-v2/slurm_error_%j.txt
#SBATCH --job-name=traj-entropy-detailed-v2
...
mkdir -p ./output/ArcherCodeR/Archer-TrajectoryEntropy-Qwen2.5-1.5B-2k-8k-batch64-no-kl-simple-detailed-v2
