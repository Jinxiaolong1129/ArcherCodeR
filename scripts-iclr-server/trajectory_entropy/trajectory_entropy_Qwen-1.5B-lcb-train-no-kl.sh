#!/usr/bin/env bash
# =====================================================================
# Trajectory Entropy Training on LiveCodeBench Dataset (NO KL)
# =====================================================================
# This script trains on LiveCodeBench data directly.
# Uses average log probability as intrinsic reward signal.
...
exp_name='TrajectoryEntropy-LCB-Qwen2.5-1.5B-2k-8k-no-kl-v2'
...
echo "🚀 TRAJECTORY ENTROPY ON LIVECODEBENCH (NO KL LOSS):"
