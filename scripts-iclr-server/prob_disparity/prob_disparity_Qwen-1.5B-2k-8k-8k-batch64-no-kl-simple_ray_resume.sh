...
exp_name='Archer-ProbDisparity-Qwen2.5-1.5B-2k-8k-batch64-no-kl-simple'
...
echo "🚀 PROBABILITY DISPARITY CONFIGURATION (NO KL LOSS - SIMPLE RAY - RESUME):"
...
echo "🔄 Resume Mode: AUTO (from latest checkpoint)"
...
/data/xuandong_zhao/anaconda3/envs/archer/bin/python -m verl.trainer.main_ppo \
    ...
    trainer.balance_batch=False $@ 2>&1 | tee ${CKPTS_DIR}/${project_name}_${exp_name}_prob_disparity_resume.log
