...
#SBATCH --output=./output/ArcherCodeR/Archer-ProbDisparity-Qwen2.5-1.5B-2k-8k-batch64-no-kl-temp1.2/slurm_out_%j.txt
#SBATCH --error=./output/ArcherCodeR/Archer-ProbDisparity-Qwen2.5-1.5B-2k-8k-batch64-no-kl-temp1.2/slurm_error_%j.txt
#SBATCH --job-name=prob-disparity-no-kl-temp1.2
...
bash scripts-iclr-server/prob_disparity/prob_disparity_Qwen-1.5B-2k-8k-8k-batch64-no-kl-temp1.2.sh
