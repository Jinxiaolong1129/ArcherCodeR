#!/usr/bin/env bash
# =====================================================================
# Probability Disparity Training on LiveCodeBench Dataset (NO KL)
# =====================================================================
# This script trains on LiveCodeBench data directly.
# Uses top-1 vs top-2 probability gap as intrinsic reward signal.
...
exp_name='ProbDisparity-LCB-Qwen2.5-1.5B-2k-8k-no-kl-v2'
...
echo "🚀 PROBABILITY DISPARITY ON LIVECODEBENCH (NO KL LOSS):"
