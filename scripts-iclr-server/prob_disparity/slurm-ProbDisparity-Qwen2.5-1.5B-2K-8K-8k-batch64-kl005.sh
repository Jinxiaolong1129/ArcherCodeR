...
#SBATCH --output=./output/ArcherCodeR/Archer-ProbDisparity-Qwen2.5-1.5B-2k-8k-batch64-kl005/slurm_out_%j.txt
#SBATCH --error=./output/ArcherCodeR/Archer-ProbDisparity-Qwen2.5-1.5B-2k-8k-batch64-kl005/slurm_error_%j.txt
#SBATCH --job-name=prob-disparity-qwen2.5-1.5b-2k-8k-8k-batch64-kl005
...
mkdir -p ./output/ArcherCodeR/Archer-ProbDisparity-Qwen2.5-1.5B-2k-8k-batch64-kl005
...
bash scripts-iclr-server/prob_disparity/prob_disparity_Qwen-1.5B-2k-8k-8k-batch64-kl005.sh ray_init.num_cpus=160
