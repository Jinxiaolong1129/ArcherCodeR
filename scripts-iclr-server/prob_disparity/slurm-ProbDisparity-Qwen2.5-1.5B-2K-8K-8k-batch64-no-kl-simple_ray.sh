...
#SBATCH --job-name=prob-disparity-qwen2.5-1.5b-2k-8k-8k-batch64-no-kl-simple
...
bash scripts-iclr-server/prob_disparity/prob_disparity_Qwen-1.5B-2k-8k-8k-batch64-no-kl-simple_ray.sh ray_init.num_cpus=160
