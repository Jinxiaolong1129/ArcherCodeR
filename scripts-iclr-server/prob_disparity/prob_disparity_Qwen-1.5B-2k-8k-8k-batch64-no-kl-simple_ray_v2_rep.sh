...
exp_name='Archer-ProbDisparity-Qwen2.5-1.5B-2k-8k-batch64-no-kl-simple-v2-rep'
...
echo "🚀 PROBABILITY DISPARITY CONFIGURATION (NO KL LOSS - SIMPLE RAY - FROM SCRATCH):"
