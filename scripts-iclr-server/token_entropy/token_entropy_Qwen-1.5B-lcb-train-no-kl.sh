#!/usr/bin/env bash
# =====================================================================
# Token Entropy Training on LiveCodeBench Dataset (NO KL)
# =====================================================================
# This script trains on LiveCodeBench data directly.
# Uses negative average entropy as intrinsic reward signal.
...
exp_name='TokenEntropy-LCB-Qwen2.5-1.5B-2k-8k-no-kl-v2'
...
echo "🚀 TOKEN ENTROPY ON LIVECODEBENCH (NO KL LOSS):"
