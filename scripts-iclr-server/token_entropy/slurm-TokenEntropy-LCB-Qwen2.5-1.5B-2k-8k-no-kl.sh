...
#SBATCH --output=./output/ArcherCodeR/TokenEntropy-LCB-Qwen2.5-1.5B-2k-8k-no-kl-v2/slurm_out_%j.txt
#SBATCH --error=./output/ArcherCodeR/TokenEntropy-LCB-Qwen2.5-1.5B-2k-8k-no-kl-v2/slurm_error_%j.txt
#SBATCH --job-name=token-entropy-lcb-no-kl
...
mkdir -p ./output/ArcherCodeR/TokenEntropy-LCB-Qwen2.5-1.5B-2k-8k-no-kl-v2

ray stop --force 2>/dev/null || true

bash scripts-iclr-server/token_entropy/token_entropy_Qwen-1.5B-lcb-train-no-kl.sh
