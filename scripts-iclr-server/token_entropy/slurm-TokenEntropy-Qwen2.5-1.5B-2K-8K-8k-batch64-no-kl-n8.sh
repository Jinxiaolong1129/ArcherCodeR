...
#SBATCH --output=./output/ArcherCodeR/Archer-TokenEntropy-Qwen2.5-1.5B-2k-8k-batch64-no-kl-n8/slurm_out_%j.txt
#SBATCH --error=./output/ArcherCodeR/Archer-TokenEntropy-Qwen2.5-1.5B-2k-8k-batch64-no-kl-n8/slurm_error_%j.txt
#SBATCH --job-name=token-entropy-no-kl-n8
...
bash scripts-iclr-server/token_entropy/token_entropy_Qwen-1.5B-2k-8k-8k-batch64-no-kl-n8.sh
