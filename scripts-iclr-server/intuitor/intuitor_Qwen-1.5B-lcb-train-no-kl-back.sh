#!/usr/bin/env bash
# =====================================================================
# Intuitor Training on LiveCodeBench Dataset (NO KL)
# =====================================================================
# This script trains on LiveCodeBench data directly.
# Since Intuitor uses self-certainty (not ground_truth) for training,
# there is NO data leakage - the model never sees the test cases.
# =====================================================================
set -xeuo pipefail
...
exp_name='Intuitor-LCB-Qwen2.5-1.5B-2k-4k-16resp-no-kl-wenbo_server'

adv_estimator=intuitor

# kl config - DISABLED for pure Intuitor (no-kl version)
...
# =====================================================================
# BATCH SIZE ADJUSTMENT FOR LIVECODEBENCH (279 samples)
# =====================================================================
train_prompt_bsz=8
...
# =====================================================================
# KEY CHANGE: Train on LiveCodeBench data!
# =====================================================================
TRAIN_FILE=$data_dir/test/livecodebench_v5.json
...
gen_tp=4   # increased from 2 to distribute vLLM memory across more GPUs
...
echo "🚀 INTUITOR ON LIVECODEBENCH (NO KL):"
...
echo "🎯 Algorithm: Intuitor (self-certainty, NO ground_truth leakage)"
...
/scr/xiaolong/miniconda3/envs/archer/bin/python -m verl.trainer.main_ppo \
    ...
    trainer.save_freq=5 \
    +trainer.save_first_step=5 \
    +trainer.save_interval_after_first=10 \
    trainer.test_freq=5 \
