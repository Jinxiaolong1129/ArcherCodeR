...
#SBATCH --output=./output/ArcherCodeR/Archer-Intuitor-Qwen2.5-1.5B-2k-4k-batch64/slurm_out_%j.txt
#SBATCH --error=./output/ArcherCodeR/Archer-Intuitor-Qwen2.5-1.5B-2k-4k-batch64/slurm_error_%j.txt
#SBATCH --job-name=intuitor-qwen-1.5b-2k-4k-4k-batch64
...
mkdir -p ./output/ArcherCodeR/Archer-Intuitor-Qwen2.5-1.5B-2k-4k-batch64

# Stop any existing Ray processes
ray stop --force 2>/dev/null || true

bash scripts/intuitor/intuitor_Qwen-1.5B-2k-4k-4k-batch64.sh
