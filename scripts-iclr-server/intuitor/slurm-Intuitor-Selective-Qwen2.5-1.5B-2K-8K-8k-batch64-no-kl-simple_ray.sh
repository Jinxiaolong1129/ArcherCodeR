...
#SBATCH --output=./output/ArcherCodeR/Archer-Intuitor-Selective-Qwen2.5-1.5B-2k-8k-batch64-no-kl-new/slurm_out_%j.txt
#SBATCH --error=./output/ArcherCodeR/Archer-Intuitor-Selective-Qwen2.5-1.5B-2k-8k-batch64-no-kl-new/slurm_error_%j.txt
#SBATCH --job-name=intuitor-selective-qwen2.5-1.5b-2k-8k-8k-batch64-no-kl-new
...
mkdir -p ./output/ArcherCodeR/Archer-Intuitor-Selective-Qwen2.5-1.5B-2k-8k-batch64-no-kl-new
...
bash scripts/intuitor/intuitor_selective_Qwen-1.5B-2k-8k-8k-batch64-no-kl-new_ray.sh
