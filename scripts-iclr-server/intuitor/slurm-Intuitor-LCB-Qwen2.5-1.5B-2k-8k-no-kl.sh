...
#SBATCH --output=./output/ArcherCodeR/Intuitor-LCB-Qwen2.5-1.5B-2k-8k-no-kl/slurm_out_%j.txt
#SBATCH --error=./output/ArcherCodeR/Intuitor-LCB-Qwen2.5-1.5B-2k-8k-no-kl/slurm_error_%j.txt
#SBATCH --job-name=intuitor-lcb-no-kl
...
bash scripts-iclr-server/intuitor/intuitor_Qwen-1.5B-lcb-train-no-kl.sh
