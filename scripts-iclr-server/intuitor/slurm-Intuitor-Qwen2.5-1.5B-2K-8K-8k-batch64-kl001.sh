...
#SBATCH --output=./output/ArcherCodeR/Archer-Intuitor-Qwen2.5-1.5B-2k-8k-batch64-kl001/slurm_out_%j.txt
#SBATCH --error=./output/ArcherCodeR/Archer-Intuitor-Qwen2.5-1.5B-2k-8k-batch64-kl001/slurm_error_%j.txt
#SBATCH --job-name=intuitor-qwen2.5-1.5b-2k-8k-8k-batch64-kl001
...
mkdir -p ./output/ArcherCodeR/Archer-Intuitor-Qwen2.5-1.5B-2k-8k-batch64-kl001

# Stop any existing Ray processes
ray stop --force 2>/dev/null || true

bash scripts/intuitor/intuitor_Qwen-1.5B-2k-8k-8k-batch64-kl001.sh
