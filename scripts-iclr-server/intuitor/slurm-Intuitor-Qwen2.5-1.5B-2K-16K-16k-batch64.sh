...
#SBATCH --output=./output/ArcherCodeR/Archer-Intuitor-Qwen2.5-1.5B-2k-16k-batch64/slurm_out_%j.txt
#SBATCH --error=./output/ArcherCodeR/Archer-Intuitor-Qwen2.5-1.5B-2k-16k-batch64/slurm_error_%j.txt
#SBATCH --job-name=intuitor-qwen2.5-1.5b-2k-16k-16k-batch64
...
mkdir -p ./output/ArcherCodeR/Archer-Intuitor-Qwen2.5-1.5B-2k-16k-batch64-kl005

# Stop any existing Ray processes
ray stop --force 2>/dev/null || true

# Run the training script with explicit Ray CPU configuration
bash scripts/intuitor/intuitor_Qwen-1.5B-2k-16k-16k-batch64.sh ray_init.num_cpus=160
