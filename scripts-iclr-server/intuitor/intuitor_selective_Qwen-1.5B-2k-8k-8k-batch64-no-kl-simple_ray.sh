...
exp_name='Archer-Intuitor-Selective-Qwen2.5-1.5B-2k-8k-batch64-no-kl-simple'
...
echo "🚀 INTUITOR_SELECTIVE CONFIGURATION (NO KL LOSS - SIMPLE RAY):"
...
echo "🎯 Algorithm: Intuitor Selective (smart training + livecodebench validation)"
