...
exp_name='Archer-Intuitor-Selective-Qwen2.5-1.5B-2k-8k-batch64-no-kl-from-grpo_120'
...
GRPO_CHECKPOINT_PATH=./output/ArcherCodeR/Archer-Qwen2.5-1.5B-2K-8K-16resp-no-kl/global_step_120
...
/data/xuandong_zhao/anaconda3/envs/archer/bin/python -m verl.trainer.main_ppo \
    ...
    trainer.resume_from_path="${GRPO_CHECKPOINT_PATH}" \
