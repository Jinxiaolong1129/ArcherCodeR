...
#SBATCH --output=./output/ArcherCodeR/Archer-Intuitor-Qwen2.5-1.5B-2k-8k-batch64-no-kl-temp0.8/slurm_out_%j.txt
#SBATCH --error=./output/ArcherCodeR/Archer-Intuitor-Qwen2.5-1.5B-2k-8k-batch64-no-kl-temp0.8/slurm_error_%j.txt
#SBATCH --job-name=intuitor-qwen2.5-1.5b-no-kl-temp0.8
...
bash scripts-iclr-server/intuitor/intuitor_Qwen-1.5B-2k-8k-8k-batch64-no-kl-temp0.8.sh
