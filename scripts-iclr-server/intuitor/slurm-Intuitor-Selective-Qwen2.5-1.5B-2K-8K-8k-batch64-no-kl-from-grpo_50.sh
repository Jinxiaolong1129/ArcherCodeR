...
#SBATCH --output=./output/ArcherCodeR/Archer-Intuitor-Selective-Qwen2.5-1.5B-2k-8k-batch64-no-kl-from-grpo_50/slurm_out_%j.txt
#SBATCH --error=./output/ArcherCodeR/Archer-Intuitor-Selective-Qwen2.5-1.5B-2k-8k-batch64-no-kl-from-grpo_50/slurm_error_%j.txt
#SBATCH --job-name=intuitor-selective-qwen2.5-1.5b-2k-8k-8k-batch64-no-kl-from-grpo_50
...
mkdir -p ./output/ArcherCodeR/Archer-Intuitor-Selective-Qwen2.5-1.5B-2k-8k-batch64-no-kl-from-grpo_50
...
bash scripts-iclr-server/intuitor/intuitor_selective_Qwen-1.5B-2k-8k-8k-batch64-no-kl-from-grpo_50.sh 
