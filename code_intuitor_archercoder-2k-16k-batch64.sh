...
exp_name='Archer-Intuitor-Qwen2.5-1.5B-2k-8k-batch64'
nnodes=1

# Sequence lengths (matching Archer script)
max_prompt_length=$((1024 * 2))  # 2K
max_response_length=$((1024 * 16))   
v_max_response_length=$((1024 * 16)) 

# Memory optimization options (uncomment if needed)
# export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True
# train_prompt_bsz=32  # Further reduce if OOM
# n_resp_per_prompt=8  # Further reduce if OOM
