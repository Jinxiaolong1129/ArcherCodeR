...
echo "Ray environment cleaned successfully"
...
echo "Ray environment variables set for local cluster creation"
...
echo "🚀 INTUITOR CONFIGURATION (NO KL LOSS):"
