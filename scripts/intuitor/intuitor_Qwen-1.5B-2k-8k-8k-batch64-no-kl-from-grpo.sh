...
exp_name='Archer-Intuitor-Qwen2.5-1.5B-2k-8k-batch64-no-kl-from-grpo'
...
echo "🚀 INTUITOR CONFIGURATION (FROM GRPO CHECKPOINT):"
...
echo "🎯 Algorithm: Switching from GRPO to Intuitor"
