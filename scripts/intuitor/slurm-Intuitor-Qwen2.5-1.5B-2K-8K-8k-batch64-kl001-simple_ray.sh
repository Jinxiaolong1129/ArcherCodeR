...
#SBATCH --output=./output/ArcherCodeR/Archer-Intuitor-Qwen2.5-1.5B-2k-8k-batch64-kl001-simple/slurm_out_%j.txt
#SBATCH --error=./output/ArcherCodeR/Archer-Intuitor-Qwen2.5-1.5B-2k-8k-batch64-kl001-simple/slurm_error_%j.txt
#SBATCH --job-name=intuitor-qwen2.5-1.5b-2k-8k-8k-batch64-kl001-simple
