...
#SBATCH --output=./output/ArcherCodeR/Archer-Qwen2.5-3B-2K-16K-16resp/slurm_out_%j.txt
#SBATCH --error=./output/ArcherCodeR/Archer-Qwen2.5-3B-2K-16K-16resp/slurm_error_%j.txt
#SBATCH --job-name=archer-qwen2.5-3b-2k-16k-16resp
...
mkdir -p ./output/ArcherCodeR/Archer-Qwen2.5-3B-2K-16K-16resp

# Stop any existing Ray processes
ray stop --force 2>/dev/null || true

# Run the training script with explicit Ray CPU configuration
bash scripts/train/run_Archer-Qwen2.5-3B-2K-16K-16resp.sh ray_init.num_cpus=160 