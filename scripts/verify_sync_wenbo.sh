#!/bin/bash
# 验证同步完成脚本 - wenbo_server
# 用法: ./verify_sync_wenbo.sh [目录名]

# 配置
SSH_KEY="/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/ssh/wenbo_server"
REMOTE_USER="xiaolong"
REMOTE_HOST="128.111.28.87"
REMOTE_BASE="/scr/xiaolong/ArcherCodeR/output/ArcherCodeR"
LOCAL_BASE="/data/xuandong_zhao/mnt/xiaolong/ArcherCodeR/output/ArcherCodeR"

SSH_OPTS="-i ${SSH_KEY} -o StrictHostKeyChecking=no"

# 默认验证的目录
DIR_NAME="${1:-Archer-TokenEntropy-Qwen2.5-1.5B-2k-8k-batch64-no-kl-temp0.8}"

LOCAL_DIR="${LOCAL_BASE}/${DIR_NAME}"
REMOTE_DIR="${REMOTE_BASE}/${DIR_NAME}"

echo "=========================================="
echo "🔍 验证同步 (wenbo_server): ${DIR_NAME}"
echo "=========================================="
echo ""
